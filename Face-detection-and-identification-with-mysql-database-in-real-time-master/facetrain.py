...
path='D:\Python\AccessEbal0\Face-detection-and-identification-with-mysql-database-in-real-time-master\DataSet'  #path of the image sample where the images are saved
